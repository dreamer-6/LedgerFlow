    ...
    router.post('/masters/items', (req, res) => {
        try {
            ...
            const existing = db.prepare('SELECT item_id, item_name FROM stock_items WHERE company_id = ? AND LOWER(item_name) = LOWER(?)')
                .get(targetCompanyId, b.itemName.trim());
            if (existing) {
      ...
      `).run(itemId, targetCompanyId, b.itemName.trim(), b.itemCode || null, b.sku || null, b.hsnSac || '9999', unitId, b.gstRate || 18, b.cessRate || 0, b.purchaseRatePaise || 0, b.sellingRatePaise || 0, b.openingQty || 0, b.openingRatePaise || 0, b.reorderLevel || 0);
